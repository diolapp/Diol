...
import app.diol.dialer.historyitemactions.DividerModule;
...
import app.diol.dialer.shortcuts.ShortcutRefresher;
import app.diol.dialer.speeddial.ContextMenu.ContextMenuItemListener;
import app.diol.dialer.speeddial.FavoritesViewHolder.FavoriteContactsListener;
import app.diol.dialer.speeddial.HeaderViewHolder.SpeedDialHeaderListener;
import app.diol.dialer.speeddial.SuggestionViewHolder.SuggestedContactsListener;
import app.diol.dialer.speeddial.database.SpeedDialEntry.Channel;
import app.diol.dialer.speeddial.draghelper.SpeedDialItemTouchHelperCallback;
import app.diol.dialer.speeddial.draghelper.SpeedDialLayoutManager;
