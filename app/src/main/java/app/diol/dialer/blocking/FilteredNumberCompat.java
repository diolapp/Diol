...
import app.diol.dialer.database.FilteredNumberContract.FilteredNumberSources;
import app.diol.dialer.database.FilteredNumberContract.FilteredNumberTypes;
 ...
 * app.diol.dialer.database.FilteredNumberContract} and using {@link
...
public class FilteredNumberCompat {
    ...
    public static Intent createManageBlockedNumbersIntent(Context context) {
        ...
        Intent intent = new Intent("app.diol.dialer.action.BLOCKED_NUMBERS_SETTINGS");
