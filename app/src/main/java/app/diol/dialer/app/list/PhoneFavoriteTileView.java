...
import app.diol.contacts.common.list.ContactTileView;
...
import app.diol.dialer.callintent.SpeedDialContactType;
...
/**
 * A light version of the {@link app.diol.contacts.common.list.ContactTileView} that is used in
