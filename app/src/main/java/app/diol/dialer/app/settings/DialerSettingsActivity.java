...
import app.diol.R;
import app.diol.dialer.about.AboutPhoneFragment;
...
import app.diol.dialer.voicemail.settings.VoicemailSettingsFragment;
    ...
    public void onBuildHeaders(List<Header> target) {
        ...
        if (isAssistedDialingEnabled) {
            ...
            assistedDialingSettingsHeader.intent =
                    new Intent("app.diol.dialer.app.settings.SHOW_ASSISTED_DIALING_SETTINGS");
