...
import app.diol.R;
import app.diol.contacts.common.util.StopWatch;
...
import app.diol.dialer.common.concurrent.DialerFutureSerializer;
...
public class DialerDatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String ACTION_SMART_DIAL_UPDATED =
            "app.diol.dialer.database.ACTION_SMART_DIAL_UPDATED";
    @VisibleForTesting
     ...
     */
    private static final String DATABASE_LAST_CREATED_SHARED_PREF = "app.diol.dialer";
