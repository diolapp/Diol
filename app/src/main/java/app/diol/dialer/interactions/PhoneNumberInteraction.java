...
import app.diol.R;
import app.diol.contacts.common.Collapser;
import app.diol.contacts.common.Collapser.Collapsible;
    ...
    private void startInteraction(Uri uri) {
        ...
        if (!PermissionsUtil.hasPhonePermissions(context)) {
            ...
            ActivityCompat.requestPermissions(
                    (AppCompatActivity) context, new String[]{permission.CALL_PHONE}, REQUEST_CALL_PHONE);
            return;
        }
        ...
        if (deniedContactsPermissions.length > 0) {
            ...
            ActivityCompat.requestPermissions(
                    (AppCompatActivity) context, deniedContactsPermissions, REQUEST_READ_CONTACTS);
            return;
        }
