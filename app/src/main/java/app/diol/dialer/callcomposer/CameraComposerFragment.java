...
import app.diol.dialer.callcomposer.camera.CameraManager.CameraManagerListener;
import app.diol.dialer.callcomposer.camera.CameraManager.MediaCallback;
import app.diol.dialer.callcomposer.camera.CameraPreview.CameraPreviewHost;
import app.diol.dialer.callcomposer.camera.camerafocus.RenderOverlay;
import app.diol.dialer.callcomposer.cameraui.CameraMediaChooserView;
...
public class CameraComposerFragment extends CallComposerFragment
    ...
    /**
     * Called by {@link app.diol.dialer.callcomposer.camera.ImagePersistTask} when the image is
    ...
    /**
     * Called by {@link app.diol.dialer.callcomposer.camera.ImagePersistTask} when the image failed
