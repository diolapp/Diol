...
import app.diol.dialer.common.preference.SwitchPreferenceWithClickableSummary;
...
public class VoicemailSettingsFragment extends PreferenceFragment
    ...
    // Extras copied from app.diol.phone.settings.VoicemailSettingsActivity,
    // it does not recognize EXTRA_PHONE_ACCOUNT_HANDLE in O.
    @VisibleForTesting
    static final String SUB_ID_EXTRA =
            "app.diol.phone.settings.SubscriptionInfoHelper.SubscriptionId";
    // Extra on intent containing the label of a subscription.
    @VisibleForTesting
    static final String SUB_LABEL_EXTRA =
            "app.diol.phone.settings.SubscriptionInfoHelper.SubscriptionLabel";
