...
package app.diol.dialer.calllog.database.contract;
...
public class AnnotatedCallLogContract {
    ...
    public static final class AnnotatedCallLog implements BaseColumns {
         ...
         * app.diol.dialer.DialerPhoneNumber} proto. The number may be empty if it was an incoming
         ...
         * <p>TYPE: BLOB
         *
         * @see app.diol.dialer.NumberAttributes
         */
