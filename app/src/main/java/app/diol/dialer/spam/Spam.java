...
public interface Spam {
     ...
     *                                app.diol.dialer.logging.ReportingLocation}.
     * @param contactLookupResultType The result of the contact lookup for this phone number. Must be
     *                                one of {@link app.diol.dialer.logging.ContactLookupResult}.
     */
     ...
     *                          indicates its source. Must be one of {@link app.diol.dialer.logging.ContactSource}.
     */
