 ...
 */
package app.diol.dialer.phonelookup.consolidator;
...
import app.diol.dialer.phonelookup.PhoneLookupInfo.Cp2Info.Cp2ContactInfo;
import app.diol.dialer.phonelookup.PhoneLookupInfo.PeopleApiInfo;
import app.diol.dialer.phonelookup.PhoneLookupInfo.PeopleApiInfo.InfoType;
...
public final class PhoneLookupInfoConsolidator {
    ...
    /**
     * Returns a {@link app.diol.dialer.logging.ContactSource.Type} representing the source from
