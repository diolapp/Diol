...
import app.diol.dialer.contactphoto.BitmapUtil;
...
import app.diol.dialer.lettertile.LetterTileDrawable.ContactType;
...
import app.diol.incallui.async.PausableExecutorImpl;
...
import app.diol.incallui.ringtone.DialerRingtoneManager;
import app.diol.incallui.ringtone.InCallTonePlayer;
import app.diol.incallui.ringtone.ToneGeneratorFactory;
...
import static app.diol.contacts.common.compat.CallCompat.Details.PROPERTY_ENTERPRISE_CALL;
import static app.diol.incallui.NotificationBroadcastReceiver.ACTION_ACCEPT_VIDEO_UPGRADE_REQUEST;
import static app.diol.incallui.NotificationBroadcastReceiver.ACTION_ANSWER_SPEAKEASY_CALL;
import static app.diol.incallui.NotificationBroadcastReceiver.ACTION_ANSWER_VIDEO_INCOMING_CALL;
import static app.diol.incallui.NotificationBroadcastReceiver.ACTION_ANSWER_VOICE_INCOMING_CALL;
import static app.diol.incallui.NotificationBroadcastReceiver.ACTION_DECLINE_INCOMING_CALL;
import static app.diol.incallui.NotificationBroadcastReceiver.ACTION_DECLINE_VIDEO_UPGRADE_REQUEST;
import static app.diol.incallui.NotificationBroadcastReceiver.ACTION_HANG_UP_ONGOING_CALL;
import static app.diol.incallui.NotificationBroadcastReceiver.ACTION_TURN_OFF_SPEAKER;
import static app.diol.incallui.NotificationBroadcastReceiver.ACTION_TURN_ON_SPEAKER;
