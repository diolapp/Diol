...
public class CheckableImageButton extends AppCompatImageButton implements Checkable {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        contentDescriptionChecked =
                typedArray.getText(R.styleable.CheckableImageButton_contentImageDescriptionChecked);
        contentDescriptionUnchecked =
                typedArray.getText(R.styleable.CheckableImageButton_contentImageDescriptionUnchecked);
        typedArray.recycle();
