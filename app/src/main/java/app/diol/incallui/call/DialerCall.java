...
import app.diol.R;
import app.diol.contacts.common.compat.CallCompat;
...
import app.diol.dialer.callintent.CallIntentParser;
...
import app.diol.dialer.enrichedcall.EnrichedCallManager.Filter;
...
import app.diol.dialer.logging.ContactLookupResult.Type;
...
import app.diol.incallui.latencyreport.LatencyReport;
import app.diol.incallui.rtt.protocol.RttChatMessage;
import app.diol.incallui.videotech.VideoTech;
import app.diol.incallui.videotech.VideoTech.VideoTechListener;
import app.diol.incallui.videotech.duo.DuoVideoTech;
import app.diol.incallui.videotech.empty.EmptyVideoTech;
import app.diol.incallui.videotech.ims.ImsVideoTech;
...
public class DialerCall implements VideoTechListener, StateChangedListener, CapabilitiesListener {
    ...
    private app.diol.dialer.logging.VideoTech.Type selectedAvailableVideoTechType =
            app.diol.dialer.logging.VideoTech.Type.NONE;
    ...
    public VideoTech getVideoTech() {
        if (videoTech == null) {
            ...
            if (selectedAvailableVideoTechType == app.diol.dialer.logging.VideoTech.Type.NONE) {
    ...
    public app.diol.dialer.logging.VideoTech.Type getSelectedAvailableVideoTechType() {
