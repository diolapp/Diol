...
import app.diol.incallui.InCallPresenter.InCallOrientationListener;
...
import app.diol.incallui.call.DialerCall.CameraDirection;
import app.diol.incallui.call.InCallVideoCallCallbackNotifier;
import app.diol.incallui.call.InCallVideoCallCallbackNotifier.SurfaceChangeListener;
 ...
 * app.diol.incallui.VideoCallPresenter} performs the following negotiation with the telephony
 * layer:
 *
 * <ul>
...
public class VideoCallPresenter
    ...
    private void updateRemoteVideoSurfaceDimensions() {
        AppCompatActivity activity = (AppCompatActivity) videoCallScreen.getVideoCallScreenFragment().getActivity();
        if (activity != null) {
