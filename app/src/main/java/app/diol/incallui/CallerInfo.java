...
import app.diol.contacts.common.util.TelephonyManagerUtils;
...
public class CallerInfo {
    ...
    private static int getColumnIndexForPersonId(Uri contactRef, Cursor cursor) {
        ...
        // - content://app.diol.contacts/data/phones ==> use the "contact_id" column
        // - content://app.diol.contacts/phone_lookup ==> use the "_ID" column
        // - content://app.diol.contacts/data ==> use the "contact_id" column
        ...
        if (url.startsWith("content://app.diol.contacts/data/phones")) {
        ...
        } else if (url.startsWith("content://app.diol.contacts/data")) {
        ...
        } else if (url.startsWith("content://app.diol.contacts/phone_lookup")) {
