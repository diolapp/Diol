...
import app.diol.dialer.blockreportspam.BlockReportSpamDialogs;
...
public class SpamNotificationActivity extends FragmentActivity {
     ...
     */
    static final String ACTION_ADD_TO_CONTACTS = "app.diol.incallui.spam.ACTION_ADD_TO_CONTACTS";
    /**
     * Action to show dialog.
     */
    static final String ACTION_SHOW_DIALOG = "app.diol.incallui.spam.ACTION_SHOW_DIALOG";
    /**
     * Action to mark a number as spam.
     */
    static final String ACTION_MARK_NUMBER_AS_SPAM =
            "app.diol.incallui.spam.ACTION_MARK_NUMBER_AS_SPAM";
    /**
     * Action to mark a number as not spam.
     */
    static final String ACTION_MARK_NUMBER_AS_NOT_SPAM =
            "app.diol.incallui.spam.ACTION_MARK_NUMBER_AS_NOT_SPAM";

    static final String ACTION_ENABLE_SPAM_BLOCKING =
            "app.diol.incallui.spam.ACTION_ENABLE_SPAM_BLOCKING";

    static final String ACTION_SHOW_SPAM_BLOCKING_PROMO_DIALOG =
            "app.diol.incallui.spam.ACTION_SHOW_SPAM_BLOCKING_PROMO_DIALOG";
