...
import app.diol.dialer.common.backoff.ExponentialBaseCalculator;
...
import app.diol.voicemail.impl.transcribe.grpc.GetTranscriptResponseAsync;
...
public class GetTranscriptReceiver extends BroadcastReceiver {
    ...
    static final String POLL_ALARM_ACTION =
            "app.diol.voicemail.impl.transcribe.GetTranscriptReceiver.POLL_ALARM";
