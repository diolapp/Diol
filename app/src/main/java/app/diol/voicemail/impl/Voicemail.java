...
public class Voicemail implements Parcelable {
    ...
    private Voicemail(Long timestamp, String number, PhoneAccountHandle phoneAccountHandle, Long id, Long duration,
                      String source, String providerData, Uri uri, Boolean isRead, Boolean hasContent, String transcription) {
     ...
     *
     * <p>
     * The id and source data fields are mandatory for update - id is necessary for
     * updating the database and source data is necessary for updating the server.
     */
     ...
     *
     * <p>
     * This may be missing in the case of a new {@link Voicemail} that we plan to
     * insert into the content provider, since until it has been inserted we don't
     * know what id it should have. If none is specified, we return -1.
     */
    public long getId() {
        return id;
    }
    ...
    /**
     * The number of the person leaving the voicemail, empty string if unknown, null
     * if not set.
     */
    ...
    /**
     * The timestamp the voicemail was received, in millis since the epoch, zero if
     * not set.
     */
    ...
    /**
     * Gets the duration of the voicemail in millis, or zero if the field is not
     * set.
     */
    ...
    /**
     * Returns the package name of the source that added this voicemail, or null if
    ...
    /**
     * Returns the application-specific data type stored with the voicemail, or null
     * if this field is not set.
     *
     * <p>
     * Source data is typically used as an identifier to uniquely identify the
     * voicemail against the voicemail server. This is likely to be something like
     * the IMAP UID, or some other server-generated identifying string.
     */
    ...
    /**
     * Gets the Uri that can be used to refer to this voicemail, and to make it
     * play.
     *
     * <p>
    ...
    /**
     * Returns the text transcription of this voicemail, or null if this field is
     * not set.
     */
    ...
    /**
     * Builder pattern for creating a {@link Voicemail}. The builder must be created
     * with the {@link #createForInsertion(long, String)} method.
     *
     * <p>
    ...
    public static class Builder {
        ...
        public Voicemail build() {
            ...
            return new Voicemail(builderTimestamp, builderNumber, builderPhoneAccount, builderId, builderDuration,
                    builderSourcePackage, builderSourceData, builderUri, builderIsRead, builderHasContent, builderTranscription);
        }
    }
}
