 ...
 *
 * <p>
 * An atom, quoted string, literal, are all represented by this. Values like OK,
 * STATUS are too. Also, this class class may contain more arbitrary value like
 * "BODY[HEADER.FIELDS ("DATE")]". See {@link ImapResponseParser}.
 */
public abstract class ImapString extends ImapElement {
    ...
    // en_US-like date format is used like "01-Jan-2009 11:20:39 -0800", so this
    // should be
     ...
     * <p>
     * Note: IMAP NIL is considered an empty string. See
     * {@link ImapResponseParser #parseBareString}. On the other hand, a
     * quoted/literal string with value NIL (i.e. "NIL" and {3}\r\nNIL) is
     * treated literally.
     */
    ...
    /**
     * @return value parsed as a number, or {@code defaultValue} if the string is
     * not a number.
     */
