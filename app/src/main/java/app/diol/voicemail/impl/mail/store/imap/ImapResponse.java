...
public class ImapResponse extends ImapList {
    ...
    static boolean isStatusResponse(String symbol) {
        return ImapConstants.OK.equalsIgnoreCase(symbol) || ImapConstants.NO.equalsIgnoreCase(symbol)
                || ImapConstants.BAD.equalsIgnoreCase(symbol) || ImapConstants.PREAUTH.equalsIgnoreCase(symbol)
    ...
    /**
     * @param index        where {@code responseType} should appear. e.g. 1 for
     *                     "FETCH"
     * @param responseType e.g. "FETCH"
     * @return whether it's an {@code responseType} data response. (i.e. not
     * tagged).
     */
     ...
     * <p>
     * e.g. "System shutdown in 10 minutes" for "* OK [ALERT] System
