 ...
 *
 * <p>
 * Data passed through this exception should be considered non-localized. Any
 * strings should either be internal-only (for debugging) or server-generated.
 *
 * <p>
 * TO DO: Does it make sense to further collapse AuthenticationFailedException
 * and CertificateValidationException and any others into this?
 */
