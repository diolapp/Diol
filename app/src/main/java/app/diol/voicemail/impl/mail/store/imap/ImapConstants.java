...
public final class ImapConstants {
    ...
    public static final String FETCH_FIELD_BODY_PEEK_SANE = String.format(Locale.US, "BODY.PEEK[]<0.%d>",
            ImapStore.FETCH_BODY_SANE_SUGGESTED_SIZE);
    public static final String FETCH_FIELD_HEADERS = "BODY.PEEK[HEADER.FIELDS (date subject from content-type to cc message-id content-duration)]";
    ...
    // The password received from the client does not match the password defined in
    // the subscriber's
    // profile.
    ...
    // The subscriber is provisioned for the VVM service but the VVM service is
