...
public class XmlUtils {
    ...
    public static final ArrayMap<String, ?> readThisArrayMapXml(XmlPullParser parser, String endTag, String[] name,
    ...
    /**
     * Read an ArrayList object from an XmlPullParser. The XML data could previously
     * have been generated by writeListXml(). The XmlPullParser must be positioned
     * <em>after</em> the tag that begins the list.
     *
    ...
    /**
     * Read a String[] object from an XmlPullParser. The XML data could previously
     * have been generated by writeStringArrayXml(). The XmlPullParser must be
    ...
    private static Object readThisValueXml(XmlPullParser parser, String[] name, ReadMapCallback callback,
    ...
    public interface ReadMapCallback {
        ...
        /**
         * Called from readThisMapXml when a START_TAG is not recognized. The input
         * stream is positioned within the start tag so that attributes can be read
         * using in.getAttribute.
         *
